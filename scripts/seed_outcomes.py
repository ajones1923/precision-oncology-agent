...
Loads outcome_seed_data.json and uses OutcomeIngestPipeline to parse
and embed each record into the onco_outcomes Milvus collection.
...
from src.ingest.outcome_parser import OutcomeIngestPipeline
...
def main():
    ...
    print("=" * 60)
    print("Precision Oncology -- Outcome Data Seeder")
    print("=" * 60)
    ...
    print("\n[3/3] Ingesting outcome seed data...")
    pipeline = OutcomeIngestPipeline(
